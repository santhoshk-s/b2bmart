...
<div className='bg-green-500'> 
  ...
  <div className='text-center p-5'>
    ...
    <img src={ind} alt="" />
    <p className='font-semibold'>Industrial Plants, Machinery & Equipments</p>
  </div>
  </Link>
  <Link to="/c2">
  <div className='text-center p-5' > <img src={c2} alt="" />
  <p className='font-semibold'>Customer Electronics and household applications</p></div>
  </Link>
  <Link to="/c3">
  <div className='text-center p-5' ><img src={c3} alt="" />
  <p className='font-semibold'>building and Construction Materials</p></div>
  </Link>
  <Link to="/c4">
  <div className='text-center p-5'> <img src={c4} alt="" />
  <p className='font-semibold'>Clothing And Garments</p></div>
  </Link>
  <Link to="/c5">
  <div className='text-center p-5'> <img src={c5} alt="" />
  <p className='font-semibold'>Medical And Consultancy Services</p></div>
  </Link>
  <Link to="/c6">
  <div className='text-center p-5'> <img src={c6} alt="" />
  <p className='font-semibold'>Medicines And Aayurvedha</p></div>
  </Link>
  <Link to='/c7'>
  <div className='text-center p-5'>  <img src={c7} alt="" />
  <p className='font-semibold'>Bicycles and Many More</p></div>
  </Link>
  <Link to='/c8'>
  <div className='text-center p-5'> <img src={c8} alt="" />
  <p className='font-semibold'>Sports Material And Equipments</p></div>
  </Link>
</div>
</>
  )
